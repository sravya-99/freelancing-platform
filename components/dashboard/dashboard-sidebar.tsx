      ...
      <SidebarHeader>
        <div className="flex items-center px-4 py-2">
          <Link href="/dashboard" className="flex items-center">
            <span className="text-xl font-bold gradient-text">Srazuka</span>
          </Link>
        </div>
      </SidebarHeader>
      <SidebarSeparator />
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/dashboard/freelancers")}>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton asChild isActive={isActive("/dashboard/screenpipe")}>
                  <Link href="/dashboard/screenpipe">
                    <MonitorCheck />
